...
namespace lve {
    ...
    void LveSwapChain::createSwapChain() {
        ...
        // ternary operator    if(oldSwapChain == nullptr){VK_NULL_HANDLE} else {oldSwapChain->swapChain}
    ...
    VkPresentModeKHR LveSwapChain::chooseSwapPresentMode(
        ...
        // low latency, not alwys supported, high power consumption
        ...
        #endif //use mailbox mode 
        #ifdef USE_IMMEDIATE_MODE
        // high power consumption, tearing, low latency, usualy supported
             for (const auto &availablePresentMode : availablePresentModes) {
        ...
        #endif // use immediate mode 
        std::cout << "Present mode: V-Sync" << std::endl;
        // always supported, good for mobile, vsync bound, latency
